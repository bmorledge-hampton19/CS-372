...
public class Person {
	...
	// The three identifiers for the Person
	private String name;
	private int age;
	private int phoneNumber;
	
	// A variable to keep track of what building the person belongs to, if any.
	...
	/**
	 * Returns the building that the citizen belongs to or null if they belong to no building.
	 * @return the building that the citizen belongs to or null if they belong to no building.
	 */
	public Building getBuilding() {return building;}
	
	/**
	 * Assigns the person to a given building.
	 * @param building specifies the building they will be assigned to.
	 */
	public void assignBuilding(Building building) {this.building = building;}
