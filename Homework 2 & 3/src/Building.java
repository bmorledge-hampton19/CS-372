...
public class Building {
	 ...
	 * @param xPos specifies the starting x position for the image.
	 * @param yPos specifies the starting y position for the image.
	 */
	public void createImage(String fileLocation, int xSize, int ySize, int xPos, int yPos) {
